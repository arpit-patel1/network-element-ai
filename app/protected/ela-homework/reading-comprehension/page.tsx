...
export default function ReadingComprehensionPage() {
  ...
  const loadQuestion = async () => {
    ...
    try {
      const response = await fetch("/api/ela/reading-comprehension", { cache: "no-store" });
        ...
        <Card className="border-2 bg-gradient-to-br from-purple-50/40 via-pink-50/30 to-transparent dark:from-purple-950/30 dark:via-pink-950/20 dark:to-transparent">
          <CardHeader className="space-y-3">
            <div className="flex items-center gap-3">
              ...
              <div>
                <CardTitle className="text-purple-800 dark:text-purple-100">Passage & Question</CardTitle>
