...
export default function ContinentPage() {
  const [data, setData] = useState<ContinentResponse | null>(null);
  ...
  const loadQuestion = async () => {
    ...
    try {
      const response = await fetch("/api/geography/continent", { cache: "no-store" });
      ...
      const questionData = (await response.json()) as ContinentResponse;
