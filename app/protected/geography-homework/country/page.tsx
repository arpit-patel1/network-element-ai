...
import { ArrowLeft, ArrowRight, Globe, Loader2, Eye, EyeOff } from "lucide-react";
...
export default function CountryPage() {
  ...
  const loadQuestion = async () => {
    ...
    try {
      const response = await fetch("/api/geography/country", { cache: "no-store" });
      ...
      const questionData = (await response.json()) as CountryResponse;
