...
import { Calculator, CheckCircle2, XCircle, Plus, Minus, X, Divide, Coins, Clock, Ruler, Shapes, BookOpen, ArrowRight, Square } from "lucide-react";
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
                ...
                <Card className="border-2 hover:border-purple-500/50 cursor-pointer transition-all hover:shadow-lg hover:shadow-purple-500/30 bg-gradient-to-br from-purple-50/40 via-pink-50/30 to-transparent dark:from-purple-950/30 dark:via-pink-950/20 dark:to-transparent flex flex-col h-full">
                  <CardHeader className="text-center pb-3">
                    ...
                    <CardTitle className="text-base text-purple-700 dark:text-purple-200">Area</CardTitle>
                    <CardDescription className="text-xs">Calculate area by counting squares</CardDescription>
                  </CardHeader>
                  <CardContent className="pt-0 mt-auto">
                    <Button
                      asChild
                      ...
                      size="sm"
                    >
                      <Link href="/protected/math-homework/area" className="flex items-center justify-center gap-2">
                        Start
                        <ArrowRight className="w-3 h-3" />
                      </Link>
                    </Button>
