...
export default function SubtractionHomeworkPage() {
  ...
  // Generate a random subtraction question based on difficulty
      ...
      <div className="w-full max-w-2xl flex flex-col gap-6">
        ...
        <div className="flex flex-col md:flex-row items-start md:items-center justify-between gap-4">
          ...
          <div className="flex gap-2">
            <Badge variant="secondary" className="px-4 py-2 bg-gradient-to-r from-orange-100 to-red-100 dark:from-orange-950 dark:to-red-950 border-orange-300 dark:border-orange-700">
        ...
        {/* Question Card */}
        <Card className="border-2 bg-gradient-to-br from-orange-50/40 to-red-50/40 dark:from-orange-950/30 dark:to-red-950/30 border-orange-200 dark:border-orange-800">
          <CardHeader>
